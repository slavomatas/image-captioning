...
class ShowAttendTellModel(nn.Module):
    ...
    def __init__(self, hidden_size, context_size, vocab_size, embed_size, feature_size=[196, 512]):
        super(ShowAttendTellModel, self).__init__()
        """ define encoder, use resnet50 """
        ...
        self.lstmcell = nn.LSTMCell(hidden_size+embed_size, hidden_size)
    ...
    def forward(self, images, captions, lengths):
        ...
        for t, batch_size in enumerate(batch_sizes):
            ...
            context, alpha = self.attention_layer(features[:batch_size], context_encode[:batch_size],
                                                  hidden[:batch_size])
